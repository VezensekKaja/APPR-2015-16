...
```{r zemljevid2, echo=FALSE, fig.align='center', fig.cap='Neto plače Julij 2015 s pikami'}
...
```{r zemljevid3, echo=FALSE, fig.align='center', fig.cap='Neto plače Julij 2015 s pikami in imeni občin'}
zem3 <- zem2 + geom_text(data = zdr %>% filter(leto == 2015, mesec == "Julij", neto > 1000)
                         %>% inner_join(placepoobcinah@data), aes(x = Y_C, y = X_C, label = kraj),
                         size = 3, vjust = 2, )
print(zem3)
